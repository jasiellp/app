...
class ItensRepository {
  Future<Map> get(String id) async {
    DocumentSnapshot querySnapshot =
        await Firestore.instance.collection('itens').document(id).get();
  ...
  Future<List<Map>> getAll() async {
    QuerySnapshot querySnapshot =
        await Firestore.instance.collection('itens').getDocuments();
  ...
  Future<String> create(Map data) async {
    ...
    await Firestore.instance.collection('itens').add(data).catchError((e) {
      print(e);
      return e.toString();
    });
  ...
  Future<List<Map>> update(String id, Map data) async {
    DocumentReference reference =
        await Firestore.instance.collection('itens').document(id);
